...
```bash
dotnet dev-certs https -v -ep openiddict.pfx -p 9763de68-e0a5-4a00-900d-e0ae3d4a2e66
```

> `9763de68-e0a5-4a00-900d-e0ae3d4a2e66` is the password of the certificate, you can change it to any password you want.
